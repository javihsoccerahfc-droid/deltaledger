...
export default async function ReportPage({ params }: { params: { id: string } }) {
  ...
  const provenance = await getExposureProvenanceAction(params.id);
  ...
  return <ReportClient ecName={ec?.name ?? ""} report={report} outcomes={outcomes} records={records} provenance={provenance} />;
}
